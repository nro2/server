...
pub fn post_committee(conn: DbConn, ins_comm: Json<InsertCommittee>) -> Result<String, String> {
...
pub fn delete_committee(conn: DbConn, id: i32) -> Result<String, String> {
    use crate::schema::committee::dsl::*;
...
pub fn post_faculty(conn: DbConn, ins_fac: Json<InsertFaculty>) -> Result<String, String> {
...
pub fn delete_faculty(conn: DbConn, qemail: String) -> Result<String, String> {
    use crate::schema::faculty::dsl::*;
...
pub fn post_department(conn: DbConn, ins_dep: Json<InsertDepartment>) -> Result<String, String> {
...
pub fn delete_department(conn: DbConn, id: i32) -> Result<String, String> {
    use crate::schema::department::dsl::*;
